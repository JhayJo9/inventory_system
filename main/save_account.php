...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        $sql = "INSERT INTO users (username, password, first_name, last_name, role_id, status) VALUES (?, ?, ?, ?, ?, ?)";
      ...
      <div class="card-body">
        ...
        <form id="addAccountForm" action="save_account.php" method="POST">
          ...
          <div class="mt-4 d-flex justify-content-end">
            ...
            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#confirmSaveModal">Save</button>
          </div>
        </form>
      </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="confirmSaveModalLabel">Confirm Add</h5>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-success" onclick="document.getElementById('addAccountForm').submit()">Save</button>
        </div>
      </div>
    </div>
  </div>
